    ...
    for i, pkt in enumerate(packets):
        ...
        try:
            ...
            # ==========================================================
                ...
                # Scapy breaks ICMPv6 into many classes (EchoRequest, EchoReply, NS, NA, etc.)
                # We check if the packet has ANY layer that inherits from the base 'Packet' and has a 'cksum' field
                # A safe way is to check specifically for the ICMPv6 Next Header (58)
                
                if pkt[IPv6].nh == 58: # 58 is ICMPv6
                    ip6 = pkt[IPv6]
                    # We need to find the payload layer to calculate length and checksum
                    # Usually pkt[IPv6].payload
                    icmpv6 = ip6.payload
...
if __name__ == "__main__":
    # Ensure you have 'traffic.pcap' in the same folder
